...
-- -----------------------------------------------------
-- Table `patrimonio_ideau`.`usuarios`
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Table `patrimonio_ideau`.`categorias`
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Table `patrimonio_ideau`.`fornecedores`
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Table `patrimonio_ideau`.`setores_locais`
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Table `patrimonio_ideau`.`patrimonios`
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Table `patrimonio_ideau`.`movimentacoes`
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Table `patrimonio_ideau`.`manutencoes`
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Table `patrimonio_ideau`.`depreciacoes`
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Table `patrimonio_ideau`.`notas_fiscais`
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Table `patrimonio_ideau`.`itens_nota_fiscal`
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Table `patrimonio_ideau`.`auditorias`
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Table `patrimonio_ideau`.`garantias`
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Table `patrimonio_ideau`.`centro_custo`
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Table `patrimonio_ideau`.`patrimonios_centro_custo`
-- -----------------------------------------------------
...
-- ... (Seção da Tabela patrimonios no seu schema.sql) ...
CREATE TABLE IF NOT EXISTS `patrimonio_ideau`.`patrimonios` (
  `id_patrimonio` INT NOT NULL AUTO_INCREMENT,
  -- ... (outros campos) ...
  `valor_compra` DECIMAL(10,2) NOT NULL,
...
-- ... (No final do seu schema.sql) ...
-- Inserção de categorias padrão conforme solicitado
INSERT INTO `patrimonio_ideau`.`categorias` (`nome_categoria`, `descricao`) VALUES
('Moveis', 'Bens móveis e utensílios de escritório.'),
('Imobilizados', 'Bens de uso da empresa com vida útil superior a um ano.'),
('Eletronicos', 'Equipamentos eletrônicos e de informática.');
